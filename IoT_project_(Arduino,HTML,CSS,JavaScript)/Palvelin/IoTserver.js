...
app.get("/api/targets", function (req, res) {
    ...
    let targets = fs.readFileSync("/home/admin/server/targets.txt", "utf8");
...
app.post("/data", function (req, res) {
    let arvot = fs.readFileSync("/home/admin/server/dataBase.txt", "utf8");
...
app.post("/api/upload", function (req, res) {
    ...
    fs.writeFile("/home/admin/server/dataBase.txt", valuesJson, (err) => {
        if (err) {
            console.log(err);
        }
    });
